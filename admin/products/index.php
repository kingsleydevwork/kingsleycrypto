...
<?php
    ...
    if (isset($_GET['del_id'])){
        ...
        $id = $_GET['del_id'];
        $sql = mysqli_query($connection , "DELETE FROM `products` WHERE `id`='$id'");
                        ...
                        <tbody>
                          ...
                          <?php 
                              ...
                              if ( mysqli_num_rows($query) > 0) {
                                ...
                                while ( $userlist = mysqli_fetch_assoc($query) )  { $count++; ?>
                                    ...
                                    <tr>
                                      ...
                                      <td> <?php  echo $userlist['brand']   ?></td>
                                      <td> <?php  echo $userlist['categorie']   ?></td>
                                      <td> <?php  echo $userlist['model']   ?></td>
                                      <td> <?php  echo $userlist['productcondition']   ?></td>
                                      <td> <?php  echo $userlist['year']   ?></td>
                                      <td>
                              ...
                              <?php  }
                                  ...
                                  <td>
                                    <span class="pl-2"  style="color: red;" >you have no product</span>
                                  </td>
