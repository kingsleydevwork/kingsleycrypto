...
if (isset($_GET['del_id'])) {
    ...
    if ($sql) {
        ...
        echo "<script>  alert('UNABLE TO DECLINE PLEASE CONTACT KINGSLEY')</script>";
    }
}
...
if (isset($_GET['app_id'])) {
    ...
    if ($sql) {
        ...
        echo "<script>  alert('UNABLE TO APPROVE PLEASE CONTACT KINGSLEY')</script>";
    }
}
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row ">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Pending Purchase</h4>
                                                ...
                                                if (mysqli_num_rows($query) > 0) {
                                                    ...
                                                    while ($userlist = mysqli_fetch_assoc($query)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <?php echo $userlist['client_name']   ?></td>
                                                            <td> <?php echo $userlist['client_email']   ?></td>
                                                            <td> <?php echo $userlist['product_name']   ?></td>
                                                            <td> <?php echo $userlist['product_price']   ?></td>
                                                            <td>
                                                                <a href="?del_id=<?php echo $userlist['id']   ?>">
                                                                    <div class="badge badge-outline-danger">Decline</div>
                                                                </a>
                                                            </td>
                                                            <td>
                                                                <a href="?app_id=<?php echo $userlist['id']   ?>">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="pl-2" style="color: red;">you have no pending purchase </span>
                                                        </td>
