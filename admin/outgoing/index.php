      ...
      <div class="app-container">
        ...
        <div class="app-body">
          ...
          <div class="card-body">
            ...
            t2.id AS ap_id
        FROM client t1 
        INNER JOIN withdrawal t2 ON t1.id = t2.user  
...
if (isset($_GET['user_id']) && isset($_GET['del_id']) ) {
    ...
    $sql = mysqli_query($connection,"UPDATE `withdrawal` SET `status`='declined' WHERE `id` = '$del_id'");
...
if (isset($_GET['user_id']) && isset($_GET['ap_id']) ) {
    ...
    $sql = mysqli_query($connection,"UPDATE `withdrawal` SET `status`='approved' WHERE `id` = '$del_id'");
