...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2025 at 04:19 PM
...
(4, 'Premium Plan', '15%', 'Every Day', 99999, NULL, 'bg-4.png');
...
INSERT INTO `payment_methods` (`id`, `payment_method`, `limit_range`, `charge`, `image`) VALUES
(1, 'Bitcoin', '100 - 1000000 USD', '0 USD + 0%', '4.png'),
(2, 'Ethereum', '100 - 1000000 USD', '0 USD + 0%', '3.png'),
(3, 'USDT(TRC20)', '100 - 1000000 USD', '0 USD + 0%', '1.png'),
(4, 'Dogecoin', '800 - 1000000 USD', '0 USD + 0%', '2.png');
