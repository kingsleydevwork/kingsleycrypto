            ...
            <div class="clearfix">
                <div class="wt-topbar-left">
                    <ul class="list-unstyled e-p-bx pull-left">
                        ...
                        <li><a href="mailto:info@capitalmulti">admin@capitalmulti.com</a></li>

                    </ul>
                </div>

                <div class="wt-topbar-right text-secondry">
                    ...
                    a.gflag {
                        ...
                        background-image: url(<?php echo $domain 
?>assets/gtranslate.net/flags/16.png);
                    }
                    ...
                    a.gflag:hover {
                        background-image: url(<?php echo $domain 
?>assets/gtranslate.net/flags/16a.png);
                    }
                    ...
                    <div style="display: none;" class=" language-select pull-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="#"><img src="<?php echo $domain 
?>assets/images/united-states.png" alt="">English</a></li>
                                <li><a href="#"><img src="<?php echo $domain 
?>assets/images/france.png" alt="">French</a></li>
                                <li><a href="#"><img src="<?php echo $domain 
?>assets/images/germany.png" alt="">German</a></li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="main-bar">
        <div class="container">
            ...
            <div class="logo-header mostion">
                <a href="index-2.html">
                    <img src="digitalassetcapitalcorp.com/wp/wp-content/uploads/2024/04/hedgefund-options__5_-removebg-preview.png"
            ...
            <div class="header-nav navbar-collapse collapse ">
                <ul class=" nav navbar-nav">
                    <li class="active">
                        <a href="<?php echo $domain ?>">Home</i></a>
