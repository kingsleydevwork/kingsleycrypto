...
<body id="bg">
    ...
    <div class="page-wraper">
       ...
       <?php include('./include/nav.php') ?>
                            ...
                            <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;"
                                ...
                                <ul>
                                    ...
                                    {"delay":"wait","speed":1000,"to":"y:-50px;opacity:0;","ease":"Power2.easeInOut"}
                                            ...
                                            data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                            data-paddingleft="[0,0,0,0]" style="z-index:13; text-transform:uppercase;">
                                            <a href="./plans/" class="site-button slider-btn-left">Invest Now</a>
                                        </div>
                                ...
                                <div class="section-content p-tb60 p-r30 clearfix">
                                    <div class="wt-left-part any-query">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h4 class="text-primary">+1 (587) 910-2053</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="<?php echo $domain ?>assets/hassets/js/spop.min.js"></script>
        <script src="<?php echo $domain ?>assets/hassets/js/magnific-popup.min.js"></script>
        <script src="<?php echo $domain ?>assets/hassets/js/spop.min.js"></script>
        <script src="<?php echo $domain ?>assets/hassets/js/notification.js"></script>
        <link rel="stylesheet" href="<?php echo $domain ?>assets/hassets/css/spop.min.css">
        <link rel="stylesheet" href="<?php echo $domain ?>assets/hassets/css/magnific-popup.css">
        <link rel="stylesheet" href="<?php echo $domain ?>assets/hassets/css/style-azaleaf86ef86ef86ef86ef86e.css?ver=192" id="changeTheme">
        <script src="<?php echo $domain ?>assets/hassets/js/jquery.bundlef86e.js"></script>
        <script src="<?php echo $domain ?>assets/hassets/js/scriptsf86e.js"></script>
        <script src="<?php echo $domain ?>assets/hassets/js/chartsf86e.js"></script>
