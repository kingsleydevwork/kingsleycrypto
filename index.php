...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo $domain 
     ?>assets/images/favicon.png" />

    <!-- PAGE TITLE HERE -->
    <title>capitalmulti | Online Forex, Crypto Currency Investment And Trading Platform.</title>
    ...
    <link rel="stylesheet" class="skin" type="text/css" href="<?php echo $domain 
    ...
    <link
     ...
     ?>assets/fonts.googleapis.com/css91d491d491d4.html?family=Poppins:300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">
    <link href="<?php echo $domain 
     ?>assets/fonts.googleapis.com/cssd172d172d172.html?family=Crete+Round:400,400i&amp;subset=latin-ext"
        rel="stylesheet">
       ...
       <?php include('./include/nav.php') ?>
        ...
        <div class="page-content">
                            ...
                            <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;"
                                ...
                                <ul>
                                    ...
                                    <li data-index="rs-1000" data-transition="slidingoverlayhorizontal"
                                        ...
                                        data-thumb="<?php echo $domain ?>assets/images/main-slider/slider2/slide1.jpg"
                                        ...
                                        data-description="">
                                        <!-- MAIN IMAGE -->
                                        <img src="<?php echo $domain ?>assets/images/main-slider/slider2/slide1.jpg"
                                    ...
                                    border-width:0px;">
                                            ...
                                            <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase;">
                                                <span class="text-white" style="padding-right:10px;">Invest
                                                    To</span><span class="text-primary"> Grow </span>
                                            </div>
                                    ...
                                    color:#fff;
                                    border-width:0px;">
                                            <span style="font-family: 'Poppins', sans-serif;">capitalmulti is the most
                                    ...
                                    {"delay":"wait","speed":1000,"to":"y:-50px;opacity:0;","ease":"Power2.easeInOut"}
                                            ...
                                            <a href="login/en/signup18381838.html?ref"
                                                class="site-button slider-btn-left">Get Started</a>
                                        </div>

                                        <!-- LAYER NR. 7 [ for more detail botton ] -->
                                        <div class="tp-caption tp-resizeme" id="slide-100-layer-7"
                                            data-x="['left','left','left','left']"
                                            data-hoffset="['220','220','220','320']" data-y="['top','top','top','top']"
                                    ...
                                    font-weight:500;
                                    ">
                                            <!-- <a href="https://app.capitalmulti/user/register" class="site-button white slider-btn-right">Sign Up</a> -->
                                        </div>
                                    ...
                                    {"delay":"wait","speed":1000,"to":"y:-50px;opacity:0;","ease":"Power2.easeInOut"}
                                            ...
                                            <img src="<?php echo $domain ?>assets/images/main-slider/slider2/earth.png"
                                                alt="" class="spin-city">
                                        </div>
                                    ...
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
                                            ...
                                            data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                            data-paddingleft="[0,0,0,0]" style="z-index: 13;">
                                            <img src="<?php echo $domain ?>assets/images/main-slider/slider2/bitcoin.png"
                                                alt="">
                                        </div>
                                    ...
                                    border-width:0px;">
                                            ...
                                            <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase; ">
                                                <span class="text-white" style="padding-right:10px;">Bitcoin</span><span
                                    ...
                                    border-width:0px;">
                                            <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                                                <span class="text-primary" style="padding-right:10px;">Easy &
                                                </span><span class="text-white">Secure way</span>
                                            </div>
                                    ...
                                    color:#fff;
                                    border-width:0px;">
                                            <span style="font-family: 'Poppins', sans-serif;">Don't waste any more time
                                                after seeing this opportunity, start earning now </span>
                                        </div>
                                    ...
                                    {"delay":"wait","speed":1000,"to":"y:-50px;opacity:0;","ease":"Power2.easeInOut"}
                                            ...
                                            data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                            data-paddingleft="[0,0,0,0]" style="z-index:13; text-transform:uppercase;">
                                            <a href="plans.html" class="site-button slider-btn-left">Invest Now</a>
                                        </div>
                                    ...
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
                                            style="z-index: 13;">
                                            <img src="<?php echo $domain ?>assets/images/main-slider/slider2/earth2.png"
                                                alt="" class="spin-city">
                                        </div>
                                    ...
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
                                            style="z-index: 13;">
                                            <img src="<?php echo $domain ?>assets/images/main-slider/slider2/earth2-shadow.png"
                                                alt="">
                                        </div>
                                    ...
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
                                            ...
                                            <img src="<?php echo $domain ?>assets/images/main-slider/slider2/rocket.png"
                                                alt="" class="floating">
                                        </div>
                                    ...
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
                                            ...
                                            <img src="<?php echo $domain ?>assets/images/main-slider/slider2/fire.gif"
                                                alt="" class="floating">
                                        </div>
                                    ...
                                    {"delay":"wait","speed":1000,"to":"y:-50px;opacity:0;","ease":"Power2.easeInOut"}
                                            ...
                                            <div class="coin-slide bg-full-width bg-repeat-y coin-slide-rotate"
                                                style="background-image:url(<?php echo $domain ?>assets/images/main-slider/slider2/coin-sky.png);height:100vh;">
                                            </div>
                                        </div>
                                    ...
                                    border-width:0px;">
                                            ...
                                            <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase; ">
                                                <span class="text-primary"
                                                    style="padding-right:10px;">Bitcoin</span><span
                                    ...
                                    color:#fff;
                                    border-width:0px;">
                                            <span style="font-family: 'Poppins', sans-serif;">Start earning with our
                                                stable and goal-oriented investment programs </span>
                                        </div>
                                    ...
                                    {"delay":"wait","speed":1000,"to":"y:-50px;opacity:0;","ease":"Power2.easeInOut"}
                                            ...
                                            data-paddingleft="[0,0,0,0]" style="z-index:13; text-transform:uppercase;">
                                            <a href="login/en/signup18381838.html?ref"
                                                class="site-button slider-btn-left">Start Earning</a>
                                        </div>
                                    ...
                                    {"delay":"wait","speed":1000,"to":"y:-50px;opacity:0;","ease":"Power2.easeInOut"}
                                            ...
                                            <img src="<?php echo $domain ?>assets/images/main-slider/slider2/rock.png"
                                                alt="">
                                        </div>
                                    ...
                                    {"delay":"wait","speed":1000,"to":"y:-50px;opacity:0;","ease":"Power2.easeInOut"}
                                            ...
                                            <img src="<?php echo $domain ?>assets/images/main-slider/slider2/agent.png"
                                                alt="">
                                        </div>
                                    ...
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]'
                                            ...
                                            data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                            data-paddingleft="[0,0,0,0]" style="z-index: 13;">
                                            <img src="<?php echo $domain ?>assets/images/main-slider/slider2/plant.png"
                                                alt="">
                                        </div>
                                    </li>
                                    ...
                                    <div class="col-md-9 col-sm-9">
                                        <div class="call-to-action-left p-tb20 ">
                                            ...
                                            <p>The platform carries over 100 tradable assets, unique risk management
                                                ...
                                                trading, 24 hrs, and Long term. capitalmulti gives clients an
            ...
            <div class="section-full home-about-section p-t80 bg-no-repeat bg-bottom-right"
                style="background-image:url(<?php echo $domain ?>assets/images/background/bg-coin.png)">
                <div class="container-fluid ">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="wt-box text-right">
                                <img src="<?php echo $domain ?>assets/images/background/bg-laptop.png" alt="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="wt-right-part p-b80">
                                ...
                                <div class="section-content">
                                    <div class="wt-box">
                                        <p>
                                            <strong>capitalmulti is place where traders can access real-world markets
                                                ...
                                                provide traders instant deposits, lightning fast execution, worldwide
                                                market access from around the globe, tight spreads and best client
                                                support.
                                            </strong>
                                        </p>
                                        <p>Our advanced trading robots made by our in house programming team, Our in
                                            house backtesting and strategy developer focus on dynamic trading
                                            environment. Our State of the Art AutoTrade bot technology (ATBT) is one of
                                            our most powerful trading robot for automated trading.</p>
                                        <a href="<?php echo $domain ?>about/" class="site-button text-uppercase m-r15">Read More</a>
                                        <a href="<?php echo $domain ?>plans/" class="site-button-secondry text-uppercase">Invest Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="section-content no-col-gap">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 step-number-block">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    <div class="icon-lg text-primary m-b20">
                                        <a href="#" class="icon-cell"><img src="<?php echo $domain ?>assets/images/icon/pick-4.png" alt=""></a>
                                    </div>
                                    <div class="icon-content">
                                        <div class="step-number">1</div>
                                        <h4 class="wt-tilte text-uppercase font-weight-500">Sign Up for Free</h4>
                                        <p>Open an Account with just your email address, </ br> No verification
                            ...
                            <div class="col-md-4 col-sm-4 step-number-block">
                                <div class="wt-icon-box-wraper  p-a30 center bg-secondry m-a5 ">
                                    <div class="icon-lg m-b20">
                                        <a href="#" class="icon-cell"><img src="<?php echo $domain ?>assets/images/icon/pick-28.png" alt=""></a>
                                    </div>
                                    <div class="icon-content text-white">
                                        <div class="step-number active">2</div>
                                        <h4 class="wt-tilte text-uppercase font-weight-500">Select a Package and Make
                                            Deposit</h4>
                                        <p>Choose from any of our plan that suite you. Fund your account with Bitcoins &
                                            more, No transfer fees charged..</p>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 3 -->
                            <div class="col-md-4 col-sm-4 step-number-block">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    <div class="icon-lg text-primary m-b20">
                                        <a href="#" class="icon-cell"><img src="<?php echo $domain ?>assets/images/icon/pick-12.png" alt=""></a>
                                    </div>
                                    <div class="icon-content">
                                        <div class="step-number">3</div>
                                        <h4 class="wt-tilte text-uppercase font-weight-500"> Start Earning</h4>
                                        <p>Make profits from world’s most liquid markets with your preferred base
                                            currency & account type.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="section-full p-t50 p-b50 overlay-wraper bg-parallax clouds1 bg-repeat"
                data-stellar-background-ratio="0.5" style="background-image:url(<?php echo $domain ?>assets/images/background/bg-9.jpg);">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="rocket-pic">
                                <div class="rocket-animation ">
                                    <img src="<?php echo $domain ?>assets/images/rocket.png" alt="" class="floating" />
                                    <div class="rocket-fire"> <img src="<?php echo $domain ?>assets/images/fire.gif" alt="" class="floating" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8 col-sm-6">
                            <div class="awesome-counter text-right text-white">
                                <h3 class="font-24">The capitalmulti</h3>
            ...
            <div class="section-full p-t80 p-b50">
                                ...
                                <tbody>
                                    <tr>
                                        <td data-title="Members"><img
                                                src="<?php echo $domain ?>assets/noonecares.me/wp-content/uploads/2019/01/man-selfie-with-cheating-girlfriend-2.jpg"
                                                alt="" style="width:100px;height:100px;" class="p-r6"> </td>
                                        <td data-title="Investment"><img src="<?php echo $domain ?>assets/images/coin-icon/bitcoin.png"
                                                class="p-r10" alt=""> Bitcoin</td>
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Members"><img
                                                src="<?php echo $domain ?>assets/miro.medium.com/max/1500/1_niATAZcFcK2hB5KvtIx_Ig.jpg" alt=""
                                    ...
                                    <tr>
                                        <td data-title="Members"><img
                                                src="<?php echo $domain ?>assets/i2-prod.mirror.co.uk/incoming/article17421472.ece/ALTERNATES/s615b/0_PRIO-pics-to-be-added-still-Pair-killed-taking-selfie-named.jpg"
                                                alt="" style="width:100px;height:100px;" class="p-r6"> </td>
                                        <td data-title="Investment"><img src="<?php echo $domain ?>assets/images/coin-icon/Ethereum.png"
                                                class="p-r10" alt=""> Ethereum</td>
                                    ...
                                    <tr>
                                        <td data-title="Members"><img src="<?php echo $domain ?>assets/images/name.jpg" alt=""
                                                style="width:100px;height:100px;" class="p-r6"> </td>
                                        <td data-title="Investment"><img src="<?php echo $domain ?>assets/images/coin-icon/litecoin.png"
                                                class="p-r10" alt=""> LiteCoin</td>
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Members"><img
                                                src="<?php echo $domain ?>assets/03/man-taking-a-selfie-mobile.jpg"
                                                alt="" style="width:100px;height:100px;" class="p-r6"> </td>
                                        <td data-title="Investment"><img src="<?php echo $domain ?>assets/images/coin-icon/bitcoin.png"
                                                class="p-r10" alt=""> Bitcoin</td>
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Members"><img
                                                src="<?php echo $domain ?>assets/calebstorkey.com/wp-content/uploads/2014/03/Jo-Soda-No-Make-Up-Selfie-For-Cancer.png"
                                                alt="" style="width:100px;height:100px;" class="p-r6"> </td>
                                        <td data-title="Investment"><img src="<?php echo $domain ?>assets/images/coin-icon/bitcoin.png"
                                                class="p-r10" alt="">Bitcoin</td>
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Members"><img src="<?php echo $domain ?>assets/i.redd.it/x3vk17k8mak21.png" alt=""
                                                style="width:100px;height:100px;" class="p-r6"> </td>
                                        <td data-title="Investment"><img src="<?php echo $domain ?>assets/images/coin-icon/bitcoin.png"
                                                class="p-r10" alt=""> Bitcoin</td>
                                    ...
                                    <tr>
                                        <td data-title="Members"><img src="<?php echo $domain ?>assets/images/name2.jpg" alt=""
                                                style="width:100px;height:100px;" class="p-r6"> </td>
                                        <td data-title="Investment"><img src="<?php echo $domain ?>assets/images/coin-icon/litecoin.png"
                                                class="p-r10" alt=""> Litecoin</td>
                                    ...
                                    <tr>
                                        <td data-title="Members"><img
                                                src="<?php echo $domain ?>assets/e3.365dm.com/20/04/768x432/30be3fc0f46a0b6e0c987f5c066567372cac7f957c6854b6e97bf78daa8d14dc_497627951ab51ab51ab51ab.jpg?20200424174245"
                                                alt="" style="width:100px;height:100px;" class="p-r6"> </td>
                                        <td data-title="Investment"><img src="<?php echo $domain ?>assets/images/coin-icon/bitcoin.png"
                                                class="p-r10" alt=""> Bitcoin</td>
                                    ...
                                    <tr>
                                        <td data-title="Members"><img
                                                src="<?php echo $domain ?>assets/03/teacher-home-year-old-man-with-bachelors-math-extensive-tutoring-experience-and-patience-wants-help-people-with-algebra-geometry.3c.3d"
                                                alt="" style="width:100px;height:100px;" class="p-r6"> </td>
                                        <td data-title="Investment"><img src="<?php echo $domain ?>assets/images/coin-icon/bitcoin.png"
                                                class="p-r10" alt=""> Bitcoin</td>
                    ...
                    <marquee direction="down" height="100%">
                        <table class="table" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center"><button class="btn btn-info btn-sm"><span
                            ...
                            <div class="col-md-6 col-sm-6 bg-primary">
                                <div class="section-content p-tb60 p-l30 clearfix">
                                    <div class="wt-right-part any-query-contact">
                                        <img src="<?php echo $domain ?>assets/images/any-query-contact.png" alt="hey">
                                        <div class="text-center">
                                            <h3 class="text-uppercase font-weight-500 text-white">Contact Us</h3>
                                            <p class="text-white"></p>
                                            <h4 class="text-secondry">admin@capitalmulti</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="section-full overlay-wraper bg-center bg-cover bg-no-repeat  bg-gray"
                    style="background-image:url(<?php echo $domain ?>assets/images/background/bg2.jpg)">
                    ...
                    <div class="container">
                        ...
                        <div class="row conntact-home">
                            <div class="col-md-7 col-sm-7">
                                <div class="section-content p-tb70">
                                    ...
                                    <div class="contact-home-left">
                                        <form class="xcons-contact-form" method="post" action="#">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <button name="contact-us" type="submit"
                                                        class="site-button skew-icon-btn btn-block">
                                                        <span class="font-18 inline-block text-uppercase p-lr15">Submit
                                                            Now</span>
                                                    </button>
                                                </div>
                            ...
                            <div class="contact-home-right">
                                <div>
                                    <img src="<?php echo $domain ?>assets/images/st-1.png" class="st-1" alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="section-full p-t80 p-b50 bg-center bg-full-height bg-no-repeat"
                    style="background-image:url(<?php echo $domain ?>assets/images/background/bg-testimonial.jpg);">
                    <div class="container">
                        <!-- TITLE START -->
                        <div class="section-head text-center">
                                    ...
                                    <div class="testimonial-5">
                                        ...
                                        <div class="testimonial-text clearfix">
                                            <div class="testimonial-paragraph">
                                                ...
                                                <p>Thanks to James Chris forex trader and his team, This is the real
                                                    definition of being top notch. I literally watched my account
                                        ...
                                        <div class="testimonial-text clearfix">
                                            <div class="testimonial-paragraph">
                                                ...
                                                <p>
                                                    ...
                                                    introduced me now to make so much profit, but here I am right now,
                                                    so excited.
                                    ...
                                    <div class="testimonial-5">
                                        ...
                                        <div class="testimonial-text clearfix">
                                            <div class="testimonial-paragraph">
                                                <span class="fa fa-quote-left text-primary"></span>
                                                <p>
                                                    This is just incredible and just when I think its good enough, it
                                                    just keeps getting better. Made over 4 withdarwals.
                                ...
                                <div class="item">
                                    <div class="testimonial-5">
                                        ...
                                        <div class="testimonial-text clearfix">
                                            <div class="testimonial-paragraph">
                                                <span class="fa fa-quote-left text-primary"></span>
                                                <p>I must confess that this is the best forex service I've ever
                                                    recieved.
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-a30">
                        <form id="log-form">
                            ...
                            <button type="button"
                                class="site-button-secondry text-uppercase btn-block m-b10">Submit</button>
                            <span class="font-12">Don't have an account? <a href="account/signup.html"
        ...
        <div class="preloader preloader-alt no-split"><span class="spinner spinner-alt"><img class="spinner-brand"
                    src="tenor.gif" alt=""></span></div>


        <script src="hassets/js/spop.min.js"></script>
        <script src="hassets/js/magnific-popup.min.js"></script>
        <script src="hassets/js/spop.min.js"></script>
        <script src="hassets/js/notification.js"></script>
        <link rel="stylesheet" href="hassets/css/spop.min.css">
        <link rel="stylesheet" href="hassets/css/magnific-popup.css">
        <link rel="stylesheet" href="hassets/css/style-azaleaf86ef86ef86ef86ef86e.css?ver=192" id="changeTheme">
        <script src="hassets/js/jquery.bundlef86e.js"></script>
        <script src="hassets/js/scriptsf86e.js"></script>
        <script src="hassets/js/chartsf86e.js"></script>
        ...
        <!-- JAVASCRIPT  FILES ========================================= -->
        <script src="<?php echo $domain ?>assets/js/jquery-1.12.4.min.js"></script><!-- JQUERY.MIN JS -->
        <script src="<?php echo $domain ?>assets/js/bootstrap.min.js"></script><!-- BOOTSTRAP.MIN JS -->

        <script src="<?php echo $domain ?>assets/js/bootstrap-select.min.js"></script><!-- FORM JS -->
        <script src="<?php echo $domain ?>assets/js/jquery.bootstrap-touchspin.min.js"></script><!-- FORM JS -->

        <script src="<?php echo $domain ?>assets/js/magnific-popup.min.js"></script><!-- MAGNIFIC-POPUP JS -->

        <script src="<?php echo $domain ?>assets/js/waypoints.min.js"></script><!-- WAYPOINTS JS -->
        <script src="<?php echo $domain ?>assets/js/counterup.min.js"></script><!-- COUNTERUP JS -->
        <script src="<?php echo $domain ?>assets/js/waypoints-sticky.min.js"></script><!-- COUNTERUP JS -->

        <script src="<?php echo $domain ?>assets/js/isotope.pkgd.min.js"></script><!-- MASONRY  -->

        <script src="<?php echo $domain ?>assets/js/owl.carousel.min.js"></script><!-- OWL  SLIDER  -->

        <script src="<?php echo $domain ?>assets/js/stellar.min.js"></script><!-- PARALLAX BG IMAGE   -->
        <script src="<?php echo $domain ?>assets/js/scrolla.min.js"></script><!-- ON SCROLL CONTENT ANIMTE   -->

        <script src="<?php echo $domain ?>assets/js/custom.js"></script><!-- CUSTOM FUCTIONS  -->
        <script src="<?php echo $domain ?>assets/js/shortcode.js"></script><!-- SHORTCODE FUCTIONS  -->
        <script src="<?php echo $domain ?>assets/js/switcher.js"></script><!-- SWITCHER FUCTIONS  -->
        <script src="<?php echo $domain ?>assets/js/jquery.bgscroll.js"></script><!-- BACKGROUND SCROLL -->
        <script src="<?php echo $domain ?>assets/js/tickerNews.min.js"></script><!-- TICKERNEWS-->
        <!-- TICKERNEWS FUNCTiON -->
        ...
        <script src="<?php echo $domain ?>assets/plugins/revolution/revolution/js/jquery.themepunch.tools.min.js">
        </script>
        <script src="<?php echo $domain ?>assets/plugins/revolution/revolution/js/jquery.themepunch.revolution.min.js">
        </script>

        <!-- SLIDER REVOLUTION 5.0 EXTENSIONS  (Load Extensions only on Local File Systems !  The following part can be removed on Server for On Demand Loading) -->
        <script src="<?php echo $domain ?>assets/plugins/revolution/revolution/js/extensions/revolution-plugin.js">
        </script>

        <!-- REVOLUTION SLIDER FUNCTION  ===== -->
        <script src="<?php echo $domain ?>assets/js/rev-script-1.js"></script>
        ...
        (function() {
            var options = {
                whatsapp: "+16267567241", // Telegram bot username
                call_to_action: "Message us", // Call to action
                button_color: "#FF6550", // Color of button
                position: "left", // Position may be 'right' or 'left'
            };
            var proto = 'index-3.html',
                host = "getbutton.io",
        ...
        _smartsupp.key = '9f6d6bb404576d6e5815d8c2ca1ee1a8b6a644a2';
...
<!-- Mirrored from capitalmulti/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Sep 2023 20:56:29 GMT -->

<!-- Mirrored from www.capitalmulti.com/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Mar 2025 20:52:11 GMT -->
