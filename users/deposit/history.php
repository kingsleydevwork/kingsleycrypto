...
<head>
    ...
    <title>Assetvest Shareholder - Deposit History</title>
                ...
                <div class="row justify-content-center mt-2">
                    ...
                    <div class="col-md-12">
                        <div class="right float-right mb-5">
                            <a href="<?php echo $domain  ?>users/deposit" class="btn cmn-btn">
                                Deposit Now
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive--md">
                            <table class="table style--two">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($connection, "SELECT * FROM `deposit` WHERE `user`='$id'");
                                    while ($row = mysqli_fetch_assoc($query)) {
                                    ?>
                                        <tr>
                                            <td data-label="#Trx"><?php echo $row['transactionId'] ?></td>
                                            <td data-label="Gateway"><?php echo $row['payment_name'] ?></td>
                                            ...
                                            <td data-label="Time"><?php echo $row['date'] . ' ' . $row['time'] ?></td>
