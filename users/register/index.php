  ...
  <!-- header-section end  -->
          ...
          <div class="col-xl-5 col-lg-7">
            <div class="account-card">
              ...
              <div class="account-card__body">
                <form action="https://www.capitalmulti.com/users/register" class="mt-4" onsubmit="return submitUserForm();" method="post">
                  ...
                  <div class="form-group">
        <link href="https://fonts.googleapis.com/css?family=Henny+Penny&amp;display=swap" rel="stylesheet"><div style="height: 46px; line-height: 46px; width:100%; text-align: center; background-color: #003; color: #CCA354!important; font-size: 26px; font-weight: bold; letter-spacing: 20px; font-family: 'Henny Penny', cursive;  -webkit-user-select: none; -moz-user-select: none;-ms-user-select: none;user-select: none;  display: flex; justify-content: center;" class="captcha"><span style="    float:left;     -webkit-transform: rotate(-31deg);">5</span><span style="    float:left;     -webkit-transform: rotate(-51deg);">8</span><span style="    float:left;     -webkit-transform: rotate(-56deg);">6</span><span style="    float:left;     -webkit-transform: rotate(34deg);">7</span><span style="    float:left;     -webkit-transform: rotate(-49deg);">5</span><span style="    float:left;     -webkit-transform: rotate(-32deg);">8</span></div><input type="hidden" name="captcha_secret" value="089d869294cf218bd19b6e9cd3f1fadf52d445be4c143577fb613e9066a7a568">    </div>
    ...
    <div class="form-group">
        <input type="text" name="captcha" class="form-control" placeholder="Enter code" autocomplete="off" required>
                    ...
                    <div class="col-md-12">
                      <input type="checkbox" name="terms" required> <span class="f-size-14 ml-2">I agree with the Terms and Conditions </span>
                    </div>
                  </div>
                  <div class="mt-3">
