...
<head>
    ...
    <meta property="og:url" content="https://www.assetvest-trading.com/ticket">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="right float-right mb-4">
                            <a href="<?php echo $domain ?>user/support_ticket/ticket/" class="btn cmn-btn">
                                ...
                                <tbody>
                                    ...
                                    while($row = mysqli_fetch_assoc($query)){?>
                                        ...
                                        <td class="data-row text-left">
                                            <a href="" class="text-white font-weight-bold"> <?php echo $row['subject'] ?> </a></td>
                                        <td data-label="Status">
                                            <span class="badge badge-primary py-1 px-2">Open</span>
                                        </td>
                                        <td data-label="Last reply"><?php echo $row['date'] ?></td>

                                        <td data-label="Action">
                                            <a href="#" class="icon-btn base--bg text-dark">
