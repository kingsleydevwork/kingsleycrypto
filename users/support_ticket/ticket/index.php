...
<head>
    ...
    <meta property="og:url" content="<?php echo $domain  ?>users/ticket/new">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="col-md-12 mb-30">
                            <ul class="right">
                                <li>
                                    <a href="<?php echo $domain  ?>users/user/support_ticket/ticket" class="btn float-right btn-dark" data-toggle="tooltip" data-placement="top" title="My Support Ticket">
