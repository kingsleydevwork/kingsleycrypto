...
<head>
    ...
    <title>Assetvest Shareholders - Withdraw Money</title>
    ...
    <meta name="apple-mobile-web-app-title" content="Assetvest Shareholders - Withdraw Money">

    <meta itemprop="name" content="Assetvest Shareholders - Withdraw Money">
    ...
    <meta property="og:url" content="<?php echo $domain  ?>user/withdraw">
...
<body>
                ...
                <div class="row row-payment mb-60-80 justify-content-center">
                    <div class="col-md-12">
                        <div class="right float-right mb-5">
                            <a href="<?php echo $domain  ?>user/withdraw/withdraw.php" class="btn cmn-btn">
                                Withdraw History
                            </a>
                        </div>
                    </div>
    ...
    <script>
        ...
        const paymentMethods = [{
                ...
                charge: "0 USD + 0%",
                image: "<?php echo $domain  ?>assets/images/payment/4.png"
            },
            {
                id: 2,
                ...
                limit: "100 - 1000000 USD",
                charge: "0 USD + 0%",
                image: "<?php echo $domain  ?>assets/images/payment/1.png"
            },
            {
                id: 4,
                ...
                limit: "100 - 1000000 USD",
                charge: "0 USD + 0%",
                image: "<?php echo $domain  ?>assets/images/payment/3.png"
            },
            {
                id: 5,
                ...
                charge: "0 USD + 0%",
                image: "<?php echo $domain  ?>assets/images/payment/2.png"
            }
        ];
