...
<head>
  ...
  <meta name="csrf-token" content="jGw5RGJp3wgmIz7ynl4ZxImJQbkWZ1IxOufIjvsP">
    ...
    <meta name="description" content="capitalmulti.com - Complete HYIP Investment System . Most Advanced HYIP Investment System Script in codecanyon.
...
hyip, bitcoin, investment,  hyip business, hyip script, best hyip, buy hyip script, advanced hyip script, hyip software, high yield investment program, hyip manager, hyip manager script, cheap hyip script, reliable hyip, secure hyip script, php hyip script, new hyip script, hyip program">
  ...
  <!-- header-section end  -->
    ...
    <div class="account-section bg_img" data-background="<?php echo $domain ?>users/assets/images/frontend/login/5fce3a113b6d91607350801.jpg">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-5 col-lg-7">
            <div class="account-card">
              <div class="account-card__header bg_img overlay--one" data-background="<?php echo $domain ?>users/assets/images/frontend/login/5fce3a1188a861607350801.jpg">
                <h2 class="section-title">Welcome To <span class="base--color">capitalmulti</span></h2>
                <p>account</p>
              </div>
              <div class="account-card__body">
                <form action="https://www.capitalmulti.com/users/login" class="mt-4" method="post" onsubmit="return submitUserForm();">
                  <input type="hidden" name="_token" value="jGw5RGJp3wgmIz7ynl4ZxImJQbkWZ1IxOufIjvsP">                  <div class="form-group">
                  ...
                  <div class="form-group">
        <link href="https://fonts.googleapis.com/css?family=Henny+Penny&amp;display=swap" rel="stylesheet"><div style="height: 46px; line-height: 46px; width:100%; text-align: center; background-color: #003; color: #CCA354!important; font-size: 26px; font-weight: bold; letter-spacing: 20px; font-family: 'Henny Penny', cursive;  -webkit-user-select: none; -moz-user-select: none;-ms-user-select: none;user-select: none;  display: flex; justify-content: center;" class="captcha"><span style="    float:left;     -webkit-transform: rotate(-44deg);">9</span><span style="    float:left;     -webkit-transform: rotate(-55deg);">2</span><span style="    float:left;     -webkit-transform: rotate(8deg);">0</span><span style="    float:left;     -webkit-transform: rotate(-24deg);">6</span><span style="    float:left;     -webkit-transform: rotate(47deg);">8</span><span style="    float:left;     -webkit-transform: rotate(26deg);">8</span></div><input type="hidden" name="captcha_secret" value="6a91641c46b6257e35d8a4f5dc932c6a2b40c48e43ff7457eef5df634088455b">    </div>
        ...
        <input type="text" name="captcha" class="form-control" placeholder="Enter code" autocomplete="off" required>
                  ...
                  <div class="form-row mt-2">
                    ...
                    <div class="col-sm-6 text-sm-right">
                      <p class="f-size-14">Haven't an account? <a href="<?php echo $domain ?>users/register/" class="base--color">Sign Up</a></p>
                    </div>
                  </div>
                </form>
              </div>
...
<script async src='../../d2mpatx37cqexb.cloudfront.net/delightchat-whatsapp-widget/embeds/embed.min.js'></script>
        <script>
          var wa_btnSetting = {"btnColor":"#16BE45","ctaText":"","cornerRadius":40,"marginBottom":20,"marginLeft":20,"marginRight":20,"btnPosition":"left","whatsAppNumber":"447587570944","welcomeMessage":"How can we help?","zIndex":999999,"btnColorScheme":"light"};
          window.onload = () => {
